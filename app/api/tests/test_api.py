...
class TestParser(APITestCase):
    ...
    def test_give_classification_data_to_fasttext_parser(self):
        self.parser_helper(filename='file.fast', parser=FastTextParser())

    def test_give_seq2seq_data_to_fasttext_parser(self):
        self.parser_helper(filename='file.fast', parser=FastTextParser())
...
class TestDownloader(APITestCase):
    ...
    def test_can_download_labelling_fast(self):
        self.download_test_helper(url=self.labeling_url,
                                  format='fast',
                                  expected_status=status.HTTP_200_OK)
